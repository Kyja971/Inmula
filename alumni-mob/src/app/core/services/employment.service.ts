...
export class EmploymentService {
  ...
  constructor(private _router: Router, private _http: HttpClient, private _modalCtrl: ModalController, private _toastCtrl: ToastController, private _selfInfo: SelfInformationService) { }

  getDatas() {
    try {
      this._http.get<any>(this._baseUrl).pipe(take(1)).subscribe((response) => {
